...
export const ACHIEVEMENTS = [
  ...
  {id:'boundary',name:'边界不是装饰品',stamp:'02',description:'模糊形容词和周五加活遇到你，都被要求说人话。',condition:'一轮内至少两次主动明确范围或规则',earned:({answers})=>countChoices(answers,[['ambition',0,2],['vague-brief',0],['new-tool',0,2],['friday',0,1,3]])>=2},
  ...
  {id:'translator',name:'形容词翻译许可证',stamp:'05',description:'你把“全面变化”“高级一点”和“很快吧”翻译成了具体问题。',condition:'一轮内至少两次拆解模糊表达',earned:({answers})=>countChoices(answers,[['ambition',0,2],['vague-brief',0,2],['competitor',0,2],['friday',0,2]])>=2},
